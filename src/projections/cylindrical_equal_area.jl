"""
    CylindricalEqualArea(radius, long0)
...
inv(proj::CylindricalEqualArea) = InverseCylindricalEqualArea(proj.radius, proj.long0)
...
function CylindricalEqualArea(;long0::AbstractFloat=0.0f0, k::AbstractFloat=1.0f0, radius::AbstractFloat=MEAN_RADIUS_WGS_84) 
    CylindricalEqualArea(promote(radius * k, long0)...)
end
...
"""
    InverseCylindricalEqualArea(radius, long0)
...
inv(proj::InverseCylindricalEqualArea) = CylindricalEqualArea(proj.radius, proj.long0)
